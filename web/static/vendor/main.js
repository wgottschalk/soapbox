...
var _user$project$Model$initMovieStyles = {
	parentStyle: _mdgriffith$elm_style_animation$Animation$style(
		_elm_lang$core$Native_List.fromArray(
			[
				_mdgriffith$elm_style_animation$Animation$left(
				_mdgriffith$elm_style_animation$Animation$px(0.0))
			])),
	overlayStyle: _mdgriffith$elm_style_animation$Animation$style(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Model$Movie = F6(
	function (a, b, c, d, e, f) {
		return {title: a, summary: b, releaseDate: c, imgUrl: d, expanded: e, style: f};
	});
var _user$project$Model$initMovie = F4(
	function (title, summary, release, imgUrl) {
		return A6(_user$project$Model$Movie, title, summary, release, imgUrl, false, _user$project$Model$initMovieStyles);
	});
var _user$project$Model$CardStyle = F2(
	function (a, b) {
		return {parentStyle: a, overlayStyle: b};
	});

var _user$project$Types$ShowFriends = {ctor: 'ShowFriends'};
var _user$project$Types$ComingSoon = {ctor: 'ComingSoon'};
var _user$project$Types$NowPlaying = {ctor: 'NowPlaying'};
...
var _user$project$Types$ChangeTab = function (a) {
	return {ctor: 'ChangeTab', _0: a};
};

var _user$project$Decoders_Movie$movieObjects = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Model$initMovie,
...
var _user$project$Decoders_Movie$movieListDecoder = A2(
	_elm_lang$core$Json_Decode_ops[':='],
	'movies',
	_elm_lang$core$Json_Decode$list(_user$project$Decoders_Movie$movieObjects));

var _user$project$Commands_Request$getFeedItems = function (url) {
	return A2(
		_evancz$elm_http$Http$get,
		_user$project$Decoders_Movie$movieListDecoder,
		A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4000/api/', url));
};
var _user$project$Commands_Request$fetchMovies = function (tabName) {
	var _p0 = tabName;
	switch (_p0) {
		case 'Now Playing':
			return A3(
				...
				_user$project$Types$Success,
				_user$project$Commands_Request$getFeedItems('now_playing'));
		case 'Coming Soon':
			return A3(
				_elm_lang$core$Task$perform,
				_user$project$Types$Failed,
				_user$project$Types$Success,
				_user$project$Commands_Request$getFeedItems('coming_soon'));
		default:
		...
		switch (_p0.ctor) {
			case 'NowPlaying':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Commands_Request$fetchMovies('Now Playing')
						]));
			case 'ComingSoon':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Commands_Request$fetchMovies('Coming Soon')
						]));
			case 'ShowFriends':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$View_Navbar$isActive = F2(
	function (activeTab, tabName) {
		return _elm_lang$core$Native_Utils.eq(activeTab, tabName) ? 'active' : 'inactive';
	});
var _user$project$View_Navbar$view = function (navbar) {
	return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'col-4 ',
									A2(_user$project$View_Navbar$isActive, navbar, 'Now Playing'))),
								_elm_lang$html$Html_Events$onClick(_user$project$Types$NowPlaying)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'col-4 ',
									A2(_user$project$View_Navbar$isActive, navbar, 'Coming Soon'))),
								_elm_lang$html$Html_Events$onClick(_user$project$Types$ComingSoon)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'col-4 ',
									A2(_user$project$View_Navbar$isActive, navbar, 'Friends'))),
								_elm_lang$html$Html_Events$onClick(_user$project$Types$ShowFriends)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$View_Movie$view = F2(
	function (model, key) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('placeholder')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
...
var _user$project$View_App$view = function (model) {
	var movies = A2(
		_elm_lang$core$List$indexedMap,
		F2(
			function (key, feedItem) {
				return A2(
					_elm_lang$html$Html$li,
					_elm_lang$core$Native_List.fromArray(
						[]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$View_Movie$view, feedItem, key)
						]));
			}),
		model.feed);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View_Navbar$view(model.navbar),
				A2(
				_elm_lang$html$Html$ul,
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Main$init, view: _user$project$View_App$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions})
};
