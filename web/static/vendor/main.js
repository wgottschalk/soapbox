...
var _user$project$Components_Movie$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src(model.imgUrl)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('card-overlay')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(model.releaseDate)
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(model.summary)
							]))
					]))
			]));
};
...
var _user$project$Components_Movie$Model = F5(
	function (a, b, c, d, e) {
		return {title: a, summary: b, releaseDate: c, imgUrl: d, style: e};
	});
var _user$project$Components_Movie$init = F4(
	function (title, summary, releaseDate, imgUrl) {
		var style = _mdgriffith$elm_style_animation$Style$init(
			_elm_lang$core$Native_List.fromArray(
				[
					_mdgriffith$elm_style_animation$Style_Properties$Opacity(0.0),
					A2(_mdgriffith$elm_style_animation$Style_Properties$Width, 100.0, _mdgriffith$elm_style_animation$Style_Properties$Px),
					A2(_mdgriffith$elm_style_animation$Style_Properties$Height, 281.0, _mdgriffith$elm_style_animation$Style_Properties$Px)
				]));
		return A5(_user$project$Components_Movie$Model, title, summary, releaseDate, imgUrl, style);
	});
var _user$project$Components_Movie$Msg = {ctor: 'Msg'};

var _user$project$Components_Friend$view = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_p1.username)
					])),
				A2(
				_elm_lang$html$Html$img,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src(_p1.profile_url)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
...
var _user$project$Components_Friend$update = F2(
	function (msg, model) {
		return model;
	});
var _user$project$Components_Friend$Model = F3(
	function (a, b, c) {
		return {username: a, age: b, profile_url: c};
	});
var _user$project$Components_Friend$Msg = {ctor: 'Msg'};

var _user$project$Components_Feed$movieOrFriend = function (card) {
	var _p0 = card;
	if (_p0.ctor === 'Movie') {
		return _user$project$Components_Movie$view(_p0._0);
	} else {
		return _user$project$Components_Friend$view(_p0._0);
	}
};
var _user$project$Components_Feed$renderItems = function (feed) {
	return A2(_elm_lang$core$List$map, _user$project$Components_Feed$movieOrFriend, feed);
};
var _user$project$Components_Feed$view = function (feed) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('feed container')
			]),
		_user$project$Components_Feed$renderItems(feed));
};
var _user$project$Components_Feed$Friend = function (a) {
	return {ctor: 'Friend', _0: a};
};
var _user$project$Components_Feed$Movie = function (a) {
	return {ctor: 'Movie', _0: a};
};

var _user$project$Components_Navbar$isActive = F2(
	function (activeTab, tabName) {
		return _elm_lang$core$Native_Utils.eq(activeTab, tabName) ? 'active' : 'inactive';
	});
...
var _user$project$Components_Navbar$ShowFriends = {ctor: 'ShowFriends'};
var _user$project$Components_Navbar$ComingSoon = {ctor: 'ComingSoon'};
var _user$project$Components_Navbar$NowPlaying = {ctor: 'NowPlaying'};
var _user$project$Components_Navbar$view = function (navbar) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('menu-items row')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'col-4 ',
									A2(_user$project$Components_Navbar$isActive, navbar, 'Now Playing'))),
								_elm_lang$html$Html_Events$onClick(_user$project$Components_Navbar$NowPlaying)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'col-4 ',
									A2(_user$project$Components_Navbar$isActive, navbar, 'Coming Soon'))),
								_elm_lang$html$Html_Events$onClick(_user$project$Components_Navbar$ComingSoon)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'col-4 ',
									A2(_user$project$Components_Navbar$isActive, navbar, 'Friends'))),
								_elm_lang$html$Html_Events$onClick(_user$project$Components_Navbar$ShowFriends)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Components_App$init, view: _user$project$Components_App$view, update: _user$project$Components_App$update, subscriptions: _user$project$Main$subscriptions})
};
